...
namespace Triverla\LaravelMonnify\Tests\Feature;
...
class CalculateTransactionHashTest extends TestCase
{
    ...
    {
        return new Monnify($this->config['base_url'], $this->config);
    ...
    public function testCalculateTransactionHash(): void
    {
        ...
        $computedHash = $this->fakeMonnifyClass()->Transaction()->calculateHash($payload->paymentReference, $payload->amountPaid, $payload->paidOn, $payload->transactionReference);
